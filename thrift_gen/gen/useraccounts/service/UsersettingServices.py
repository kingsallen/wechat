...
class Iface(object):
    ...
    def putResource(self, usersetting):
        """
        Parameters:
         - usersetting
        """
    ...
    def postResource(self, usersetting):
        """
        Parameters:
         - usersetting
        """
...
class Client(Iface):
    ...
    def putResource(self, usersetting):
        ...
        self._seqid += 1
        future = self._reqs[self._seqid] = concurrent.Future()
        self.send_putResource(usersetting)
        return future

    def send_putResource(self, usersetting):
        oprot = self._oprot_factory.getProtocol(self._transport)
        oprot.writeMessageBegin('putResource', TMessageType.CALL, self._seqid)
        args = putResource_args()
        args.usersetting = usersetting
        args.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def postResource(self, usersetting):
        ...
        self._seqid += 1
        future = self._reqs[self._seqid] = concurrent.Future()
        self.send_postResource(usersetting)
        return future

    def send_postResource(self, usersetting):
        oprot = self._oprot_factory.getProtocol(self._transport)
...
class Processor(Iface, TProcessor):
    ...
    def process_putResource(self, seqid, iprot, oprot):
        ...
        iprot.readMessageEnd()
        result = putResource_result()
        result.success = yield gen.maybe_future(self._handler.putResource(args.usersetting))
    ...
    def process_postResource(self, seqid, iprot, oprot):
        ...
        iprot.readMessageEnd()
        result = postResource_result()
        result.success = yield gen.maybe_future(self._handler.postResource(args.usersetting))
...
class putResource_args(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.STRUCT, 'usersetting', (thrift_gen.gen.useraccounts.struct.ttypes.Usersetting, thrift_gen.gen.useraccounts.struct.ttypes.Usersetting.thrift_spec), None, ),  # 1
    )

    def __init__(self, usersetting=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.usersetting = thrift_gen.gen.useraccounts.struct.ttypes.Usersetting()
                    self.usersetting.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.usersetting is not None:
            oprot.writeFieldBegin('usersetting', TType.STRUCT, 1)
            self.usersetting.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
