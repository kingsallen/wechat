...
class ResultOfSaveRoomVO(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(HRChatRoomVO)
HRChatRoomVO.thrift_spec = (
    None,  # 0
...
all_structs.append(HRChatRoomsVO)
HRChatRoomsVO.thrift_spec = (
    None,  # 0
    ...
    (5, TType.LIST, 'rooms', (TType.STRUCT, [HRChatRoomVO, None], False), None, ),  # 5
)
all_structs.append(HRChatRoomsIndexVO)
HRChatRoomsIndexVO.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'userId', None, None, ),  # 1
    (2, TType.I32, 'pageSize', None, None, ),  # 2
    (3, TType.I32, 'totalRow', None, None, ),  # 3
    (4, TType.LIST, 'rooms', (TType.STRUCT, [HRChatRoomVO, None], False), None, ),  # 4
)
all_structs.append(UserChatRoomVO)
UserChatRoomVO.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'id', None, None, ),  # 1
...
all_structs.append(UserChatRoomsVO)
UserChatRoomsVO.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'pageNo', None, None, ),  # 1
    (2, TType.I32, 'pageSize', None, None, ),  # 2
    (3, TType.I32, 'totalPage', None, None, ),  # 3
    (4, TType.I32, 'totalRow', None, None, ),  # 4
    (5, TType.LIST, 'rooms', (TType.STRUCT, [UserChatRoomVO, None], False), None, ),  # 5
)
all_structs.append(ChatVO)
ChatVO.thrift_spec = (
    None,  # 0
...
ChatsVO.thrift_spec = (
    ...
    (3, TType.I32, 'totalPage', None, None, ),  # 3
    (4, TType.I32, 'totalRow', None, None, ),  # 4
    (5, TType.LIST, 'chatLogs', (TType.STRUCT, [ChatVO, None], False), None, ),  # 5
)
all_structs.append(HrVO)
HrVO.thrift_spec = (
    None,  # 0
...
all_structs.append(PositionVO)
PositionVO.thrift_spec = (
    None,  # 0
...
all_structs.append(ResultOfSaveRoomVO)
ResultOfSaveRoomVO.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'roomId', None, None, ),  # 1
    (2, TType.BOOL, 'chatDebut', None, None, ),  # 2
    (3, TType.STRUCT, 'position', [PositionVO, None], None, ),  # 3
    (4, TType.STRUCT, 'user', [UserVO, None], None, ),  # 4
    (5, TType.STRUCT, 'hr', [HrVO, None], None, ),  # 5
)
