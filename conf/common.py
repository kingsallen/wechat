...
# 神策推荐来源
# 直接推荐
SA_DIRECT_REFERRAL_ORIGIN_WECHAT_UPLOAD = "微信上传"
SA_DIRECT_REFERRAL_ORIGIN_PHONE_UPLOAD = "手机本地上传"
SA_DIRECT_REFERRAL_ORIGIN_PC_UPLOAD = "PC上传"
SA_DIRECT_REFERRAL_ORIGIN_REFERRAL_CRUCIAL_INFO = "推荐关键信息"
# 间接评价
SA_INDIRECT_REFERRAL_REFERRAL = 1
SA_INDIRECT_REFERRAL_INVITE = 2
SA_INDIRECT_REFERRAL_TRANSFER = 3
# 推荐评价
