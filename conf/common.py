...
# 神策推荐来源
# 直接推荐
SA_DIRECT_REFERRAL_ORIGIN_WECHAT_UPLOAD = 1  # 微信上传
SA_DIRECT_REFERRAL_ORIGIN_PHONE_UPLOAD = 2  # 手机本地上传
SA_DIRECT_REFERRAL_ORIGIN_PC_UPLOAD = 3  # PC上传
SA_DIRECT_REFERRAL_ORIGIN_REFERRAL_CRUCIAL_INFO = 4  # 推荐关键信息
# 间接推荐
SA_INDIRECT_REFERRAL_ORIGIN_CONTACT_MES_TMP = 1    # 候选人联系内推消息模板
SA_INDIRECT_REFERRAL_ORIGIN_RADAR = 2              # 人脉雷达
SA_INDIRECT_REFERRAL_ORIGIN_PROGRESS = 3     # 推荐进度列表
SA_INDIRECT_REFERRAL_ORIGIN_TEN_MIN_MES_TMP = 4    # 十分钟消息推送模板
SA_INDIRECT_REFERRAL_ORIGIN_SEEK_RECOM_CARDS = 5   # 求推荐分类统计卡
