...
class HrAppCvConfDataService(DataService):
    ...
    def get_app_cv_conf(self, conds, fields=None, options=None, appends=None):
        ...
        if conds is None or not (isinstance(conds, (dict, str))):
            self.logger.warning("Warning:[get_app_cv_conf][invalid parameters], Detail:[conds: {0}, "
        ...
        response = yield self.hr_app_cv_conf_dao.get_record_by_conds(conds, fields, options, appends)
