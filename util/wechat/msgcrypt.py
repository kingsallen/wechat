...
class WXBizMsgCrypt(object):
    ...
    def EncryptMsg(self, sReplyMsg, sNonce, timestamp = None):
        ...
        :return：成功 0，sEncryptMsg,失败返回对应的错误码None"""
...
if __name__ == "__main__":
    ...
    """
    # c37f1cd03cb111e5a2be00163e004a1f
    # YhwSCu0CGkfeaHaAE9XHXfxeX2P0r5skvlDEl1pVK2a
    # wx98aa120730a78275
    # 1012576265
    ...
    to_xml = """
                <xml>
                <ToUserName><![CDATA[oUxP0t1sl4XNFmFLSmq3qZZuORic]]></ToUserName>
                <FromUserName><![CDATA[gh_8fa00243cf97]]></FromUserName>
                <CreateTime>1440844188</CreateTime>
                <MsgType><![CDATA[text]]></MsgType>
                <Content><![CDATA[MoSeeker 欢迎您的访问！]]></Content>
                </xml>
                    """
