...
class PositionHandler(BaseHandler):
    ...
    def _add_team_data(self, position_data, team, company_id, position_id, teamname_custom):
        ...
        if team:
            module_team_position, cms_page, module_team = yield [
                self._make_team_position(team, position_id, company_id, teamname_custom),
                self._make_cms_page(team.id), self._make_team(team, teamname_custom)
            ]
