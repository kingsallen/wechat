...
from util.common.decorator import handle_response, authenticated, NewJDStatusCheckerRedirect
    ...
    def _make_send_publish_template(self, position_info):
        ...
        if position_info.visitnum == 4 and position_info.source == 0:
            ...
            if hr_wx_user.openid:
                ...
                yield position_view_five_notice_tpl(
                    help_wechat.id, hr_wx_user.openid, link,
                    position_info.title, position_info.salary)
